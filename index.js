...
// step 2 - we need a conditional - if the array is 31 flavours we want to see true, otherwise we need to see false
if(arr.length === 31){
    return true;
}else{
    return false;
...
function copy(newOriginalFlavors, originalFlavors){
    newOriginalFlavors = [...originalFlavors];
